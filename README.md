...
### Before anything make sure that you have [Python 3](https://www.python.org/downloads/){:target="_blank" rel="noopener"} installed, as well as [discord.py](https://discordpy.readthedocs.io/en/latest/intro.html){:target="_blank" rel="noopener"} 
